...
function hideShow() {
  ...
  let casterHealthHeroes = ["Achates", "Angelica", "Blood Moon Haste", "Destina", "Diene", "Elena", "Kizuna AI", "Maid Chloe", "Rin", "Roana", "Ruele of Light", "Shooting Star Achates", "Sonia", "Tamarinne"];
